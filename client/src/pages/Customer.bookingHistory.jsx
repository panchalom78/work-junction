                ...
                >
                  ...
                  <div className="flex gap-3 pt-4 border-t">
                    ...
                    {booking.status === "COMPLETED" && (
                      <button
                        className="flex-1 py-2 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-lg hover:from-purple-700 hover:to-purple-800 transition font-medium"
                      >
                        Write Review
                      </button>
                    )}
