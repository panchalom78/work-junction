    ...
    const roles = [
        {
            ...
            icon: FiHome,
            description: "Book services for your home or business",
        },
        {
            id: "WORKER",
            title: "I'm A Worker",
                ...
                >
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 text-sm">
                            Select how you want to use WorkJunction
                        </p>
                    </div>
                ...
                >
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            ...
                            now ready to explore all the features and services.
                        </p>
                    </div>
                    ...
                    <div className="w-full max-w-md lg:max-w-lg xl:max-w-xl">
                        ...
                        <div className="text-center mt-6 space-y-3">
                            ...
                            <p className="text-gray-600 text-sm lg:text-base max-w-md mx-auto">
                                Connect with trusted professionals or offer your
                                services to millions of customers across India.
                            </p>
                        </div>
                    </div>
                </motion.div>
