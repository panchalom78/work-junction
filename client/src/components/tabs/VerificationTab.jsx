...
const VerificationTab = () => {
    ...
    const DocumentStatus = ({ verification }) => {
        ...
        const docs = [
            ...
            {
                name: "Police",
                verified: isPoliceVerificationDocVerified,
                icon: Shield,
            },
        ];
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200 mb-3">
            <div className="flex justify-between items-start mb-3">
                ...
                <VerificationStatusBadge
                    status={worker.workerProfile?.verification?.status}
                />
            </div>
            ...
            <div className="flex justify-between items-center">
                ...
                <button
                    ...
                    className="flex items-center gap-1 px-3 py-2 text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors text-sm"
                >
    ...
    const getDocumentUrl = (worker, documentType) => {
        ...
        switch (documentType) {
            ...
            case "policeVerification":
                return worker.workerProfile.verification
    ...
    return (
        <div className="min-h-screen bg-gray-50/30 p-3 sm:p-6">
            ...
            <div className="mb-6">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4">
                    <div className="flex items-center justify-between sm:block">
                        <div>
                            <h4 className="text-xl sm:text-3xl font-bold text-gray-900">
                                Worker Verification
                            </h4>
                    ...
                    >
                        <div className="text-sm text-gray-500 bg-white p-3 rounded-lg sm:bg-transparent sm:p-0">
                    ...
                    <div className="flex flex-col lg:flex-row gap-3">
                        <div className="flex-1 relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base"
                            />
                        </div>
                        <div className="flex gap-2">
                            <button
                                onClick={() => setShowFilters(!showFilters)}
                                className="flex items-center gap-2 px-3 sm:px-4 py-2 border border-gray-300 rounded-xl hover:bg-gray-50 text-sm"
                            >
                            ...
                            <button
                                ...
                                className="px-3 sm:px-4 py-2 text-gray-600 border border-gray-300 rounded-xl hover:bg-gray-50 text-sm"
                            >
                                Clear
                            </button>
                        </div>
            ...
            <div className="hidden sm:block overflow-x-auto bg-white rounded-2xl shadow-sm border border-gray-200">
                    ...
                    <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col">
                        ...
                        <div className="flex justify-between items-start p-4 sm:p-6 border-b border-gray-200">
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-gray-600 text-sm sm:text-base truncate">
                                    {selectedWorker.address?.area},{" "}
                                    {selectedWorker.address?.city} -{" "}
                                    {selectedWorker.address?.pincode}
                                </p>
                            </div>
                            <button
                        ...
                        <div className="flex-1 overflow-auto p-4 sm:p-6">
                            {activeTab === "documents" && (
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <div className="flex gap-2">
                                                    <button
                                                        ...
                                                        className="flex-1 flex items-center justify-center gap-1 px-2 sm:px-3 py-2 text-xs sm:text-sm text-blue-600 border border-blue-600 rounded-lg hover:bg-blue-50"
                                                        disabled={actionLoading}
                                                    >
                                                    ...
                                                    <button
                                                        ...
                                                        className="flex-1 flex items-center justify-center gap-1 px-2 sm:px-3 py-2 text-xs sm:text-sm text-gray-600 border border-gray-300 rounded-lg hover:bg-gray-50"
                                                        disabled={actionLoading}
                                                    >
                                    ...
                                    <div className="border border-gray-200 rounded-lg p-3 sm:p-4">
                                        <div className="flex items-center gap-2 sm:gap-3 mb-3">
                                            <IdCard className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />
                                            <h3 className="font-semibold text-sm sm:text-base">
                                                Aadhaar Card
                                            </h3>
                                            {hasDocument(
                        ...
                        <div className="flex flex-col sm:flex-row justify-end gap-3 p-4 sm:p-6 border-t border-gray-200 bg-gray-50">
                            <button
                                ...
                                disabled={actionLoading}
                                className="flex items-center justify-center gap-2 px-4 sm:px-6 py-3 text-red-700 bg-red-100 border border-red-300 rounded-xl hover:bg-red-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed order-2 sm:order-1"
                            >
                                {actionLoading ? (
                            ...
                            <button
                                onClick={() =>
                                    handleApprove(selectedWorker._id)
                                }
                                disabled={actionLoading}
                                className="flex items-center justify-center gap-2 px-4 sm:px-6 py-3 text-green-700 bg-green-100 border border-green-300 rounded-xl hover:bg-green-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed order-1 sm:order-2"
                            >
                                {actionLoading ? (
