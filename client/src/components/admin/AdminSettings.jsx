        ...
        <div className="min-h-screen bg-gray-50 p-3 sm:p-4 md:p-6 lg:p-8">
            <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
                    ...
                    {/* Right Column: Security & Notifications (1 col) */}
                    <div className="space-y-4 sm:space-y-6">
                        {/* Security Card */}
                        <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
                            <div className="p-4 sm:p-5 border-b border-gray-100">
                                <h2 className="text-base sm:text-lg font-bold text-gray-900">Security</h2>
                                <p className="text-xs sm:text-sm text-gray-500">Password management</p>
                            </div>
                                ...
                                <form onSubmit={handlePasswordSubmit} className="space-y-3 sm:space-y-4">
                                    <div className="space-y-3">
                                        <input
                                            ...
                                            className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500/20 focus:border-gray-500 transition-all text-sm"
                                    ...
                                    <button
                                        ...
                                        className="w-full px-4 py-2.5 bg-gray-900 text-white rounded-lg hover:bg-gray-800 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center space-x-2 text-sm font-medium transition-all shadow-sm hover:shadow active:scale-95"
                                    >
                                        {passwordLoading ? (
                                            <>
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 shadow-sm h-fit">
                            <div className="p-4 sm:p-5 border-b border-gray-100 flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-xs sm:text-sm text-gray-500">Alert preferences</p>
                                </div>
                                <button
                                ...
                                >
                                    {notificationSaving ? (
                                        <span className="block w-4 h-4 sm:w-5 sm:h-5 border-2 border-blue-200 border-t-blue-600 rounded-full animate-spin" />
                                    ) : (
                            ...
                            <div className="p-2 space-y-1 max-h-[400px] overflow-y-auto custom-scrollbar">
                                {notificationOptions.map((option) => (
                                    <button
                                        ...
                                        className={`w-full p-3 rounded-lg text-left transition-all border ${notifications[option.key]
                                    ...
                                    >
                                        <div className="flex items-start space-x-3">
                                            <div
                                                className={`mt-0.5 w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${notifications[option.key] ? 'bg-white text-blue-600 shadow-sm' : 'bg-gray-100 text-gray-400'
                                                    }`}
                                            >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center justify-between">
                                                    <p className={`text-sm font-medium ${notifications[option.key] ? 'text-blue-900' : 'text-gray-700'}`}>
                                                        {option.label}
                                                    </p>
                                                    <div className={`w-2 h-2 rounded-full ${notifications[option.key] ? 'bg-blue-500' : 'bg-gray-200'}`} />
                                                </div>
                                                <p className={`text-xs mt-0.5 ${notifications[option.key] ? 'text-blue-700' : 'text-gray-500'}`}>
                                                    {option.description}
                                                </p>
                                            </div>
                                        </div>
