    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-2xl p-6 max-w-2xl w-full mx-auto max-h-[90vh] overflow-y-auto">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Assign Service Area</h2>
              <p className="text-sm text-gray-600 mt-1">Select an area for {selectedAgent.name}</p>
            </div>
            <button
              onClick={() => {
                setShowAreaAssignment(false);
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  ...
                  {selectedAgent.address && (
                    <div className="flex items-center space-x-1 text-sm text-gray-600">
                      ...
                      <span>{selectedAgent.address.city}, {selectedAgent.address.pincode}</span>
                    </div>
                  )}
                </div>
              </div>
          ...
          {selectedAgent.address && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mb-6">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <h4 className="font-medium text-yellow-800">Location-based Suggestion</h4>
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-900">Available Service Areas</h3>

            {availableAreas.length === 0 ? (
              <div className="text-center py-8">
                <Map className="w-12 h-12 text-gray-400 mx-auto mb-3" />
                <p className="text-gray-600 font-medium">No areas available</p>
                <p className="text-sm text-gray-500 mt-1">All service areas are currently assigned</p>
              </div>
            ) : (
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-4 mt-1">
                              <span className="text-sm text-gray-600">Pincode: {area.pincode}</span>
                              <div className="flex items-center space-x-1 text-sm text-gray-600">
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-2xl p-6 max-w-2xl w-full mx-auto max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="border border-gray-200 rounded-xl p-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Geographic Coverage Area</p>
                </div>
              </div>
            </div>
            ...
            {selectedAgent.address && (
              <div className="border border-gray-200 rounded-xl p-4">
                <h4 className="font-semibold text-gray-900 mb-3">Registered Address</h4>
                <div className="flex items-start space-x-3">
                    ...
                    <tr>
                      <td colSpan="6" className="px-6 py-12 text-center">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <p className="text-gray-600 font-medium">No service agents found</p>
